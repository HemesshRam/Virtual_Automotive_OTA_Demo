...
from ecus.cluster.firmware_receiver import FirmwareReceiver
...
class ClusterReceiver:
    ...
    def __init__(self):
        ...
        self.can = CANInterface(
            os.getenv("OTA_ECU_CLUSTER_CAN_CHANNEL", ECU_CAN_INTERFACES[CLUSTER_ID])
        )

        self.firmware_receiver = FirmwareReceiver(
            "ecus/cluster/downloads"
        )
        self.version_manager = VersionManager("cluster")
    ...
    def start(self):
        ...
        while True:
            ...
            if message.arbitration_id not in (CLUSTER_ID, BROADCAST_ID):
                continue
            ...
            if message_type == MessageType.VERSION_REQUEST:
                ...
                version = VersionManager("cluster").get_current_version()
            ...
            if message_type == MessageType.FIRMWARE_DATA:
                ...
                print(
                    f"  Stored   : {self.firmware_receiver.downloaded_size()} bytes"
                )
            ...
            if message_type == MessageType.FIRMWARE_END:
                ...
                if passed:
                    ...
                    #
                    # Notify TCU that installation finished
                    #
